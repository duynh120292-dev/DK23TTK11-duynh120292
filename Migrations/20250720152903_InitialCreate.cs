        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainImageUrl = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ...
                    HealthStatus = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    CareInstructions = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CategoryId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pets", x => x.Id);
                    table.CheckConstraint("CK_Pet_Age", "Age > 0 AND Age <= 300");
                    table.CheckConstraint("CK_Pet_Price", "Price > 0");
                    table.CheckConstraint("CK_Pet_SalePrice", "SalePrice IS NULL OR SalePrice >= 0");
                    table.CheckConstraint("CK_Pet_StockQuantity", "StockQuantity >= 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pets_IsActive_IsFeatured",
                table: "Pets",
